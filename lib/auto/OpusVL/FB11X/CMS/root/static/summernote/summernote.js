...
(function (factory) {
  ...
  var Codeview = function (context) {
    ...
    this.activate = function () {
      ...
      // This is to minimise corruption of HTML entities
      // and in TT tags prevent it entirely.
      // NOTE: this code is repeated on save by the editor.js in
      // html mode.  This is not ideal code structure.
      var str = context.layoutInfo.note.val();
      ...
      $codable.val(fudge_tt(_unescape, str));
    ...
    this.deactivate = function () {
      ...
      value = fudge_tt(_escape, value);
      var isChange = context.layoutInfo.note.val() !== value;
