...
=head1 TABLE: C<attachment_attribute_values>
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'attachment_attribute_values_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5Tsy+6ubwEdT+T5JhwKJag
