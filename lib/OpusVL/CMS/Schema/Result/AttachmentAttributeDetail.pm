...
=head1 TABLE: C<attachment_attribute_details>
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'attachment_attribute_details_id_seq'
...
=head2 attachment_attribute_values

Type: has_many

Related object: L<OpusVL::CMS::Schema::Result::AttachmentAttributeValue>
